...
The Unigraph Schema is the backbone of the UniGraph Knowledge Graph. It is inspired by the freebase schema with major modifications in the areas described in more detail below. We try to keep the schema up to date with daily commits and weekly releases.
